...
const botInfos = new Discord.RichEmbed().setAuthor(`Informations générales`,
    botAvatar)
    .setColor(0x21ACF7)
    ...
    .setTimestamp()
    .addField(`Qui est-tu ?`,
        `Je me nomme Jeeves. J'ai été créé par Bloodysunset afin de faciliter la vie des modos et de vous apporter quelques commandes et fonctionnalités.`)
...
const botCommands = new Discord.RichEmbed().setAuthor(`Commandes disponibles`,
    botAvatar)
    .setColor(0xCA0C08)
    .setFooter(`Pour plus d'informations...`, botAvatar)
    .setThumbnail(botAvatar + '?size=1024')
    ...
    .addField(`?secondChannel`,
        `Write a message in another channel. Don't ask why.`)
    ...
    .addField(`What is my avatar?`,
        `This one is particular. You need to ask Jeeves first. To do so, just call him : \`Jeeves\`, \`Jeeves?\` or \`Jeeves!\`, then ask him the command.`);
